...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN  
            ...
            SET @ResponseMessage = 'User fetched successfully';  
            SET @ErrorCode = 0; 
        END  
        ELSE
        BEGIN
            SET @ErrorLogMessage = 'User with the specified username does not exist. Failed to fetch user. [dbo].[usp_GetUserByUsername]';  
